...
if !exists("jslint_command")
  let jake_command = 'jake '
  let jake_test_command = 'jake test '
  let jslint_command = 'jake lint '
  "let jslint_command = '/Users/nukulb/.vim/plugin/jsl-0.3.0-mac/jsl'
endif
...
command JL :exec JakeLint()
command JJ :exec JakeBuild()
command JT :exec JakeTest()
function JakeLint()
  let g:test = 'lint'
  call Jake()
endfunction
...
function Jake() 
  ...
  if (g:test == "build")
      let cmd_output = system(g:jake_command)
  elseif (g:test == "test")
      let cmd_output = system(g:jake_test_command)
  elseif (g:test == "lint")
      let cmd_output = system(g:jslint_command) 
  endif
